...
use WhiteBIT\Sdk\Requests\Private\Trade\Spot\Orders\CreateStopMarketOrderRequest;

it('calls correct endpoint', function () {
    $request = new CreateStopMarketOrderRequest(
        'WBT_USDT',
        OrderTypeEnum::BUY,
        '6',
        '1'
...
test('status code is correct', function () {
    ...
    $connector->withMockClient(new MockClient([
        new BasicFixture('/api/v4/order/stop_market'),
    ]));

    $result = $connector->send(new CreateStopMarketOrderRequest('WBT_USDT', OrderTypeEnum::BUY, '6', '1'));
